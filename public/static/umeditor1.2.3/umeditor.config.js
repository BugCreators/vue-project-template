...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        ,toolbar:[
            ...
            '| horizontal print preview fullscreen', 'drafts', 'formula', 'addOption'
        ]
...
//          ]
        ...
        ,whiteList: {
			...
			dt:     ['style', 'class'],
			em:     ['style', 'class'],
            embed:  ['style', 'class', '_url', 'type', 'pluginspage', 'src', 'width', 'height', 'wmode', 'play', 'loop', 'menu', 'allowscriptaccess', 'allowfullscreen'],
			...
			hr:     ['style', 'class'],
			i:      ['style', 'class'],
            iframe: ['style', 'class', 'src', 'frameborder', 'data-latex'],
			img:    ['src', 'alt', 'title', 'width', 'height', 'style', 'class', '_url' ,'data-loading','id','data-latex'],
			...
			s:      [],
			section:[],
			point:  ['contenteditable','class'], // 加点拓展
			small:  ['style', 'class'],
			span:   ['style', 'class'],
			sub:    ['style', 'class'],
			sup:    ['style', 'class'],
			...
			u:      ['style'],
			ul:     ['style', 'class'],
            svg:    ['style', 'class', 'width', 'height', 'xmlns', 'fill', 'viewBox'],
